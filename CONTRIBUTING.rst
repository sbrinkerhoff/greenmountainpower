...
Welcome to ``greenmountainpower`` contributor's guide.
...
If you experience bugs or general issues with ``greenmountainpower``, please have a look
...
You can help improve ``greenmountainpower`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``greenmountainpower`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``greenmountainpower``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n greenmountainpower python=3 six virtualenv pytest pytest-cov
    conda activate greenmountainpower
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/greenmountainpower.git
    cd greenmountainpower
...
#. Install |pre-commit|_::
   ...
   ``greenmountainpower`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/greenmountainpower
.. _issue tracker: https://github.com/<USERNAME>/greenmountainpower/issues
.. <-- end -->
